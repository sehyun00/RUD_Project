...
const ImageUpload = ({ onSave }) => {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            const cashResponse = await axios.post('https://cbc3-61-34-253-238.ngrok-free.app/wallet', cashFormData, {
                headers: {
            ...
            const stockResponse = await axios.post('https://cbc3-61-34-253-238.ngrok-free.app/upload', stockFormData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
                onUploadProgress: () => {
            ...
            <div className="contents-container">
                ...
                <div className="image-box-container">
                    ...
                    <div className="image-box-wrapper-1">
                        ...
                        >
                            {files[0] && <img src={URL.createObjectURL(files[0])} alt="미리보기" className="image-1" />}
                            {!files[0] && (
                                <div>
                    ...
                    <div className="image-box-wrapper-2">
                        <div
                            ...
                            onDragLeave={handleDragLeave}
                        >
                            {files[1] && <img src={URL.createObjectURL(files[1])} alt="미리보기" className="image-2" />}
                            {!files[1] && (
                                <div>
            ...
            >
                <div className="info-content">
                    <div className="info-body">
                        ...
                        <br />
                        <p>
                            2. 원하는 페이지에서 우측 상단 확장프로그램 모음 → gofullpage 아이콘을 클릭 후 Download
                            image (PNG)로 캡쳐
                        </p>
                        <br />
                        ...
                        <br />
                        <br />
                        <p>3. 내 계좌 → 자산 페이지에서 우측 사이드 바 닫은 후 캡쳐.</p>
                        <br />
                        <img className="info-image-2" src={cash_blurImage} alt="도움말 이미지 2" />
                        <br />
                        <br />
                        <p>4. 우측 사이드 바 → 내 투자 페이지에서 사이드 바 닫은 후 캡쳐</p>
                        <br />
